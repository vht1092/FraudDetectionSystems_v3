...
import com.fds.ldap.authen.CustomActiveDirectoryLdapAuthenticationProvider;
import com.fds.services.FdsUserDetailsContextMapper;
...
public class SecurityConfig extends GlobalMethodSecurityConfiguration {
	...
	@Autowired
	private FdsUserDetailsContextMapper fdsUserDetailsContextMapper;
	...
	public ActiveDirectoryLdapAuthenticationProvider activeDirectoryLdapAuthenticationProvider() {
		...
		ActiveDirectoryLdapAuthenticationProvider provider = new ActiveDirectoryLdapAuthenticationProvider(sLdapDomain,
				"LDAP://" + sLdapHost + ":" + sLdapPort);
		...
		provider.setUserDetailsContextMapper(fdsUserDetailsContextMapper);
		return provider;
	}
	...
	public CustomActiveDirectoryLdapAuthenticationProvider customActiveDirectoryLdapAuthenticationProvider() {
		...
		CustomActiveDirectoryLdapAuthenticationProvider provider = new CustomActiveDirectoryLdapAuthenticationProvider(sLdapDomain,
				"ldap://" + sLdapHost + ":" + sLdapPort, "OU=OU_Synced_Users,DC=scb,DC=local");
		provider.setConvertSubErrorCodesToExceptions(true);
