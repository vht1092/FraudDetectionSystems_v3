...
@SpringComponent
@Scope("prototype")
public class ReportTransactionMonitorEbank extends ReportForm {
	private static final long serialVersionUID = -4877706024903750843L;
	public static final String CAPTION = "BC THỐNG KÊ GSGD-HTKH EB";

	public ReportTransactionMonitorEbank() {
		super.filename = "ReportTransactionMonitorEB.jasper";
	}
