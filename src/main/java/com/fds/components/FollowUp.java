...
@SpringComponent
@ViewScope
public class FollowUp extends CustomComponent implements ReloadAutoComponent, ReloadComponent {
	...
	public FollowUp() {
		...
		grid = new CaseEbankDetailGridComponent(getData(new PageRequest(FIRST_OF_PAGE, SIZE_OF_PAGE, Sort.Direction.DESC, "updTms")), true, "");
