...
public class ReopenForm extends VerticalLayout {
	...
	public ReopenForm(final Callback callback, final String caseno, final String txnUsername) {
		final String sCardNumber = txnUsername;
		...
		btSave.addClickListener(evt -> {
			...
			ebankCaseDetailService.reopenCase(sCaseNo, sUserId);
