...
public class RoleList extends CustomComponent {
	...
	private BeanItemContainer<FdsEbankSysRole> beanRoleContainer;
	private BeanItemContainer<FdsEbankSysTxn> beanScreenContainer;
	//private FormLayout formLayout;
	//private Button btSave;
	//private Grid gridRole;
	private FdsEbankSysRole fdsSysRole;
	...
	public RoleList() {
		...
		beanRoleContainer = new BeanItemContainer<FdsEbankSysRole>(FdsEbankSysRole.class);
		beanScreenContainer = new BeanItemContainer<FdsEbankSysTxn>(FdsEbankSysTxn.class);
		beanScreenContainer.addAll(sysTxnService.findAll());
		// Form for editing the bean
		final BeanFieldGroup<FdsEbankSysRole> binder = new BeanFieldGroup<FdsEbankSysRole>(FdsEbankSysRole.class);
		...
		return new CommitHandler() {
			...
			public void postCommit(CommitEvent commitEvent) throws CommitException {
				...
				for (Object a : listSelected) {
					BeanItem<FdsEbankSysTxn> beanScreenItem = beanScreenContainer.getItem(a);
