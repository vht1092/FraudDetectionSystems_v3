...
@Entity
@Table(name = "FDS_EBANK_SYS_ROLETXN")
@NamedQuery(name = "FdsEbankSysRoletxn.findAll", query = "SELECT f FROM FdsEbankSysRoletxn f")
public class FdsEbankSysRoletxn implements Serializable {
